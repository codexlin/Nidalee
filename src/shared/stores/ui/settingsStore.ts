...
export const useSettingsStore = defineStore(
  ...
  () => {
    ...
    const augmentOverlayOcrEnabled = ref(false)
    ...
    const setAugmentOverlayOcrEnabled = (enabled: boolean) => {
      augmentOverlayOcrEnabled.value = enabled
    }
    ...
    const resetAllSettings = () => {
      ...
      setAugmentOverlayOcrEnabled(false)
    }
