...
export const OVERLAY_CARD_LABEL = 'augment-overlay'
export const OVERLAY_CARD_ROUTE = '/augment-overlay'
...
export function isOverlayWindow(): boolean {
  ...
  try {
    ...
    return label === OVERLAY_SIDE_PANEL_LABEL || label === OVERLAY_CARD_LABEL
  } catch {
    return false
  }
}
