...
impl TimelineBridge {
    ...
    fn convert_timeline_analysis_to_legacy_format(
        ...
        TimelineData {
            // 对线期数据 (0-10分钟)
            cs_per_min_0_10: Some(analysis.early_game.cs_per_minute),
            gold_per_min_0_10: Some(analysis.early_game.gold_per_minute),
            xp_per_min_0_10: Some(analysis.early_game.xp_per_minute),
            cs_diff_0_10: Some(analysis.early_game.cs_difference),
            xp_diff_0_10: Some(analysis.early_game.xp_difference),
            damage_taken_per_min_0_10: None,

            // 发育期数据 (10-20分钟)
            cs_per_min_10_20: Some(analysis.mid_game.cs_per_minute),
            gold_per_min_10_20: Some(analysis.mid_game.gold_per_minute),
            xp_per_min_10_20: Some(analysis.mid_game.xp_per_minute),
            cs_diff_10_20: Some(analysis.mid_game.cs_difference),
            xp_diff_10_20: Some(analysis.mid_game.xp_difference),
            damage_taken_per_min_10_20: None,

            // 后期数据 (20分钟+)
            cs_per_min_20_end: Some(analysis.late_game.cs_per_minute),
            gold_per_min_20_end: Some(analysis.late_game.gold_per_minute),
            cs_diff_20_end: Some(analysis.late_game.cs_difference),
        }
    }
}
